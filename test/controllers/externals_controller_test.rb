...
class ExternalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create external" do
    assert_difference('External.count') do
      post externals_url, params: { external: { name: @external.name, organization_id: @external.organization_id, questmark_reference: @external.questmark_reference, room: @external.room } }
    end
  ...
  test "should update external" do
    patch external_url(@external), params: { external: { name: @external.name, organization_id: @external.organization_id, questmark_reference: @external.questmark_reference, room: @external.room } }
